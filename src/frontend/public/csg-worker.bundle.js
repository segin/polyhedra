(() => {
  // node_modules/.pnpm/three@0.164.1/node_modules/three/build/three.module.js
  const REVISION = "164";
  const FrontSide = 0;
  const BackSide = 1;
  ...
  let _textureId = 0;
  const Texture = class _Texture extends EventDispatcher {
  ...
  const Object3D = class _Object3D extends EventDispatcher {
    constructor() {
      super();
  ...
  const Triangle = class _Triangle {
  ...
  let _materialId = 0;
  const Material = class extends EventDispatcher {
    constructor() {
      super();
  ...
  const MeshBasicMaterial = class extends Material {
  ...
  const Uint16BufferAttribute = class extends BufferAttribute {
    constructor(array, itemSize, normalized) {
      super(new Uint16Array(array), itemSize, normalized);
    }
  };
  const Uint32BufferAttribute = class extends BufferAttribute {
    constructor(array, itemSize, normalized) {
      super(new Uint32Array(array), itemSize, normalized);
    }
  };
  const Float32BufferAttribute = class extends BufferAttribute {
    constructor(array, itemSize, normalized) {
  ...
  const BufferGeometry = class _BufferGeometry extends EventDispatcher {
    constructor() {
      super();
  ...
  const logdepthbuf_fragment = "#if defined( USE_LOGDEPTHBUF )\n	gl_FragDepth = vIsPerspective == 0.0 ? gl_FragCoord.z : log2( vFragDepth ) * logDepthBufFC * 0.5;\n#endif";
  const logdepthbuf_pars_fragment = "#if defined( USE_LOGDEPTHBUF )\n	uniform float logDepthBufFC;\n	varying float vFragDepth;\n	varying float vIsPerspective;\n#endif";
  ...
  const map_particle_pars_fragment = "#if defined( USE_POINTS_UV )\n	varying vec2 vUv;\n#else\n	#if defined( USE_MAP ) || defined( USE_ALPHAMAP )\n		uniform mat3 uvTransform;\n	#endif\n#endif\n#ifdef USE_MAP\n	uniform sampler2D map;\n#endif\n#ifdef USE_ALPHAMAP\n	uniform sampler2D alphaMap;\n#endif";
  ...
  const morphinstance_vertex = "#ifdef USE_INSTANCING_MORPH\n	float morphTargetInfluences[MORPHTARGETS_COUNT];\n	float morphTargetBaseInfluence = texelFetch( morphTexture, ivec2( 0, gl_InstanceID ), 0 ).r;\n	for ( int i = 0; i < MORPHTARGETS_COUNT; i ++ ) {\n		morphTargetInfluences[i] =  texelFetch( morphTexture, ivec2( i + 1, gl_InstanceID ), 0 ).r;\n	}\n#endif";
  const morphcolor_vertex = "#if defined( USE_MORPHCOLORS ) && defined( MORPHTARGETS_TEXTURE )\n	vColor *= morphTargetBaseInfluence;\n	for ( int i = 0; i < MORPHTARGETS_COUNT; i ++ ) {\n		#if defined( USE_COLOR_ALPHA )\n			if ( morphTargetInfluences[ i ] != 0.0 ) vColor += getMorph( gl_VertexID, i, 2 ) * morphTargetInfluences[ i ];\n		#elif defined( USE_COLOR )\n			if ( morphTargetInfluences[ i ] != 0.0 ) vColor += getMorph( gl_VertexID, i, 2 ).rgb * morphTargetInfluences[ i ];\n		#endif\n	}\n#endif";
  ...
  const iridescence_pars_fragment = "#ifdef USE_IRIDESCENCEMAP\n	uniform sampler2D iridescenceMap;\n#endif\n#ifdef USE_IRIDESCENCE_THICKNESSMAP\n	uniform sampler2D iridescenceThicknessMap;\n#endif";
  ...
  const DepthTexture = class extends Texture {
  ...
  const CubicInterpolant = class extends Interpolant {
    constructor(parameterPositions, sampleValues, sampleSize, resultBuffer) {
  ...
  const LinearInterpolant = class extends Interpolant {
    constructor(parameterPositions, sampleValues, sampleSize, resultBuffer) {
      super(parameterPositions, sampleValues, sampleSize, resultBuffer);
    }
    interpolate_(i1, t0, t, t1) {
  ...
  const DiscreteInterpolant = class extends Interpolant {
    constructor(parameterPositions, sampleValues, sampleSize, resultBuffer) {
      super(parameterPositions, sampleValues, sampleSize, resultBuffer);
    }
    interpolate_(i1) {
  ...
  const BooleanKeyframeTrack = class extends KeyframeTrack {
  };
  ...
  const ColorKeyframeTrack = class extends KeyframeTrack {
  };
  ColorKeyframeTrack.prototype.ValueTypeName = "color";
  const NumberKeyframeTrack = class extends KeyframeTrack {
  };
  NumberKeyframeTrack.prototype.ValueTypeName = "number";
  const QuaternionLinearInterpolant = class extends Interpolant {
    constructor(parameterPositions, sampleValues, sampleSize, resultBuffer) {
      super(parameterPositions, sampleValues, sampleSize, resultBuffer);
    }
    interpolate_(i1, t0, t, t1) {
  ...
  const QuaternionKeyframeTrack = class extends KeyframeTrack {
    InterpolantFactoryMethodLinear(result) {
  ...
  const StringKeyframeTrack = class extends KeyframeTrack {
  };
  ...
  const VectorKeyframeTrack = class extends KeyframeTrack {
  };
  VectorKeyframeTrack.prototype.ValueTypeName = "vector";
  const LoadingManager = class {
  ...
  // node_modules/.pnpm/three-csg-ts@3.2.0_@types+three@0.164.1_three@0.164.1/node_modules/three-csg-ts/lib/esm/Polygon.js
  ...
  // src/frontend/workers/csg.worker.js
  ...
  function createMesh(data) {
    ...
    if (data.attributes.position) geometry.setAttribute("position", new Float32BufferAttribute(data.attributes.position, 3));
    if (data.attributes.normal) geometry.setAttribute("normal", new Float32BufferAttribute(data.attributes.normal, 3));
    if (data.attributes.uv) geometry.setAttribute("uv", new Float32BufferAttribute(data.attributes.uv, 2));
