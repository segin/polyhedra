/* global Storage */
import { safeJSONParse, safeLocalStorageSet } from '../src/frontend/utils/OperationWrappers.js';
...
describe('OperationWrappers', () => {
  ...
  describe('safeJSONParse', () => {
    ...
    test('should return fallback and log error on invalid JSON', () => {
      ...
      expect(Logger.error).toHaveBeenCalledWith('Failed to parse JSON', expect.any(Object));
    });
  ...
  describe('safeLocalStorageSet', () => {
    ...
    test('should return false and log error on set failure', () => {
      ...
      expect(Logger.error).toHaveBeenCalledWith('Failed to write to localStorage', expect.any(Object));
      mockSetItem.mockRestore();
    });
  });
});
