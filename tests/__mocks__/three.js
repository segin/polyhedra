...
const THREE_MOCK = {
  ...
  LineSegments: jest.fn(function (geometry, material) {
    ...
    this.clone = jest.fn(function () {
      return new THREE_MOCK.LineSegments(this.geometry, this.material);
    });
  }),
  ...
  Vector3: jest.fn().mockImplementation(function (x = 0, y = 0, z = 0) {
    ...
    this.addScalar = jest.fn((s) => {
      this.x += s;
      this.y += s;
      this.z += s;
      return this;
    });
    this.divideScalar = jest.fn((s) => {
      this.x /= s;
      this.y /= s;
      this.z /= s;
      return this;
    ...
    this.equals = jest.fn(
      (v) => this.x === v.x && this.y === v.y && this.z === v.z,
    );
  }),
  ...
  Quaternion: jest.fn().mockImplementation(function (
    x = 0,
    y = 0,
    z = 0,
    w = 1,
    ...
    this.clone = jest.fn(
      () => new THREE_MOCK.Quaternion(this.x, this.y, this.z, this.w),
    );
  ...
  BoxGeometry: jest
    .fn()
    .mockImplementation(() => new THREE_MOCK.BufferGeometry()),
  SphereGeometry: jest
    .fn()
    .mockImplementation(() => new THREE_MOCK.BufferGeometry()),
};
