...
4. **High Code Coverage:** Aim for 96% code coverage for all modules
...
6. **Verify Coverage:** Run coverage reports using the project's chosen tools. For example, in a Python project, this might look like:
   ...
   ```
   Target: 96% coverage for new code. The specific tools and commands will vary by language and framework.
...
8. **Commit Code Changes with Task Summary:**
   ...
   - Propose a clear, concise commit message following the format `<type>(<scope>): <description>`, with the detailed summary in the commit body.
   - Perform the commit.
   - **Example:**
     ```bash
     git commit -m "feat(ui): Create basic HTML structure for calculator" -m "Task: Create UI structure
     Changes:
     - Added index.html with main layout
     - Created styles.css with basic grid
     Files: src/index.html, src/styles.css
     Why: Established the foundational layout for the modeling workspace."
     ```
...
6. **Create Checkpoint Commit with Verification Report:**
    ...
    - Perform the commit with a clear and concise message (e.g., `conductor(checkpoint): Checkpoint end of Phase X`), with the full verification report in the commit body.
...
- [ ] All tests pass
- [ ] Code coverage meets requirements (96%)
