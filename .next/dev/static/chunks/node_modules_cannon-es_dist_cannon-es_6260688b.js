...
"[project]/node_modules/cannon-es/dist/cannon-es.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ class ConvexPolyhedron extends Shape {
   ...
   */ pointIsInside(p) {
        ...
        return ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : -1;
    }
    /**
 ...
 */ class WheelInfo {
   ...
   * frictionSlip
   * @default 10.5
   */ /** forwardAcceleration */ /** sideAcceleration */ /**
   * steering
   * @default 0
   */ /**
 ...
 */ class RaycastVehicle {
    /** The car chassis body. */ /** The wheels. */ /** Will be set to true if the car is sliding. */ /** Index of the right axis. x=0, y=1, z=2 */ /** Index of the forward axis. x=0, y=1, z=2 */ /** Index of the up axis. x=0, y=1, z=2 */ /** The constraints. */ /** Optional pre-step callback. */ /** Number of wheels on the ground. */ constructor(options){
 ...
 */ class RigidVehicle {
   ...
   */ addToWorld(world) {
        ...
        const bodies = this.wheelBodies.concat([
            this.chassisBody
        ]);
 ...
 */ class SplitSolver extends Solver {
   ...
   */ /**
   * When tolerance is reached, the system is assumed to be converged.
   */ /** subsolver */ constructor(subsolver){
        super();
        this.iterations = 10;
        this.tolerance = 1e-7;
...
const convexHeightfield_faceList = [
    0
];
...
//# sourceMappingURL=node_modules_cannon-es_dist_cannon-es_6260688b.js.map