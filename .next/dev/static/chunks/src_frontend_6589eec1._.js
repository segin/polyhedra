...
"[project]/src/frontend/utils/Logger.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const isProduction = ("TURBOPACK compile-time value", "object") !== 'undefined' && window.location.hostname !== 'localhost';
const Logger = {
    /**
   * Initialize logging level
   */ init () {
        if (isProduction) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$loglevel$2f$lib$2f$loglevel$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].setLevel('info');
        } else {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$loglevel$2f$lib$2f$loglevel$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].setLevel('debug');
        }
    },
    /**
   ...
   */ _getCircularReplacer () {
    ...
    debug (message, meta) {
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$loglevel$2f$lib$2f$loglevel$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getLevel() <= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$loglevel$2f$lib$2f$loglevel$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].levels.DEBUG) {
            console.debug(this._format('DEBUG', message, meta));
        }
    },
    info (message, meta) {
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$loglevel$2f$lib$2f$loglevel$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getLevel() <= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$loglevel$2f$lib$2f$loglevel$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].levels.INFO) {
            console.info(this._format('INFO', message, meta));
        }
    },
    warn (message, meta) {
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$loglevel$2f$lib$2f$loglevel$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getLevel() <= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$loglevel$2f$lib$2f$loglevel$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].levels.WARN) {
            console.warn(this._format('WARN', message, meta));
        }
    },
    error (message, meta) {
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$loglevel$2f$lib$2f$loglevel$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getLevel() <= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$loglevel$2f$lib$2f$loglevel$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].levels.ERROR) {
...
"[project]/src/frontend/utils/OperationWrappers.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
// @ts-check
/* global localStorage */ var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$utils$2f$Logger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/utils/Logger.js [app-client] (ecmascript)");
;
function safeJSONParse(str, fallback = null) {
    try {
        return JSON.parse(str);
    } catch (error) {
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$utils$2f$Logger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].error('Failed to parse JSON', {
            error: error.message,
...
function safeLocalStorageSet(key, value) {
    try {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$utils$2f$Logger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].error('Failed to write to localStorage', {
            error: error.message,
            key
        });
        return false;
...
"[project]/src/frontend/ToastManager.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/frontend/logger.js [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
// @ts-check
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$ToastManager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/ToastManager.js [app-client] (ecmascript)");
;
let log;
if (("TURBOPACK compile-time value", "object") !== 'undefined' && window.log) {
    log = window.log;
} else if (("TURBOPACK compile-time value", "object") !== 'undefined' && window.loglevel) {
    log = window.loglevel;
} else {
...
"[project]/src/frontend/SceneStorage.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$utils$2f$OperationWrappers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/utils/OperationWrappers.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$logger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/frontend/logger.js [app-client] (ecmascript) <locals>");
;
;
;
class SceneStorage {
   ...
   */ async saveScene() {
        ...
        const originalToJSON = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BufferAttribute"].prototype.toJSON;
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BufferAttribute"].prototype.toJSON = function() {
            return {
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BufferAttribute"].prototype.toJSON = originalToJSON;
        }
   ...
   */ async loadScene(file) {
        try {
            ...
            if (mappingFile) {
                ...
                const bufferMapping = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$utils$2f$OperationWrappers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["safeJSONParse"])(mappingJson);
                if (!bufferMapping) {
            ...
            return new Promise((resolve, reject)=>{
                const handleMessage = (event)=>{
                    if (event.data.type === 'deserialize_complete') {
                        ...
                        const loader = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ObjectLoader"]();
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$logger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].error('Error loading scene:', error);
...
"[project]/src/frontend/utils/ServiceContainer.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/frontend/StateManager.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$utils$2f$Logger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/utils/Logger.js [app-client] (ecmascript)");
;
class StateManager {
    constructor(){
        this._state = {
            ...
            if (this._listeners.has(key)) {
                this._listeners.get(key).forEach((callback)=>{
                    try {
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$utils$2f$Logger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].error(`Error in StateManager listener for key '${key}':`, error);
                    }
                });
            }
        });
...
"[project]/src/frontend/EventBus.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        if (this.events[eventName]) {
            this.events[eventName].forEach((callback)=>{
                try {
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$logger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].error(`Error in event listener for ${eventName}:`, error);
                }
            });
        }
    }
...
"[project]/src/frontend/constants.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/frontend/ObjectManager.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
// @ts-check
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/constants.js [app-client] (ecmascript)");
;
const TEXTURE_KEYS = [
    'map',
    'normalMap',
...
class ObjectManager {
   ...
   */ selectObject(object) {
        ...
        this.eventBus.publish(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Events"].OBJECT_SELECTED, object);
    }
    /**
   ...
   */ deselectObject() {
        ...
        this.eventBus.publish(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Events"].OBJECT_DESELECTED);
    }
    /**
   ...
   */ addPrimitive(type, options) {
        ...
        if (object && !(object instanceof Promise)) {
            ...
            this.eventBus.publish(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Events"].OBJECT_ADDED, object);
        }
        return object;
    }
    /**
   ...
   */ deleteObject(object, detachFromParent = true) {
        if (object) {
            ...
            this.eventBus.publish(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Events"].OBJECT_REMOVED, object);
        }
    }
    /**
   * @param {any} material
...
"[project]/src/frontend/SceneManager.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class SceneManager {
    constructor(renderer, camera, inputManager, scene){
        ...
        if (!this.scene) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$utils$2f$Logger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].warn('Scene not injected into SceneManager, creating new one.');
        ...
        this.controls = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$examples$2f$jsm$2f$controls$2f$OrbitControls$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OrbitControls"](this.camera, this.renderer.domElement);
        ...
        const gridHelper = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GridHelper"](10, 10);
        this.scene.add(gridHelper);
        const axesHelper = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AxesHelper"](5);
    ...
    focusOnObject(object) {
        ...
        const box = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Box3"]().setFromObject(object);
        if (box.isEmpty()) return;
        const size = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector3"]();
        box.getSize(size);
        ...
        // Tween target
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tweenjs$2f$tween$2e$js$2f$dist$2f$tween$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Tween"](this.controls.target).to({
            x: center.x,
            y: center.y,
            z: center.z
        }, 500).easing(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tweenjs$2f$tween$2e$js$2f$dist$2f$tween$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Easing"].Cubic.Out).start();
        // Tween camera
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tweenjs$2f$tween$2e$js$2f$dist$2f$tween$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Tween"](this.camera.position).to({
            x: targetPosition.x,
            y: targetPosition.y,
            z: targetPosition.z
        }, 500).easing(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tweenjs$2f$tween$2e$js$2f$dist$2f$tween$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Easing"].Cubic.Out).onUpdate(()=>this.controls.update()).start();
    }
    onWindowResize() {
...
"[project]/src/frontend/InputManager.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$hammerjs$2f$hammer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/hammerjs/hammer.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/constants.js [app-client] (ecmascript)");
;
;
class InputManager {
    constructor(eventBus, domElement){
        ...
        if (("TURBOPACK compile-time value", "object") !== 'undefined' && this.domElement !== window) {
            this.setupTouchGestures();
        }
    }
    setupTouchGestures() {
        this.hammer = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$hammerjs$2f$hammer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Manager(this.domElement);
        // Add Recognizers
        this.hammer.add(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$hammerjs$2f$hammer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Pinch());
        this.hammer.add(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$hammerjs$2f$hammer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Pan({
            threshold: 10,
            pointers: 2
        }));
        this.hammer.add(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$hammerjs$2f$hammer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Press({
            time: 500
        })); // 500ms for long press
        this.hammer.add(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$hammerjs$2f$hammer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Tap({
            event: 'doubletap',
            taps: 2
        }));
        // Interaction State
        ...
        this.hammer.on('pinchstart', ()=>{
            ...
            this.eventBus.publish(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Events"].TOUCH_PINCH_START);
        });
        this.hammer.on('pinchmove', (e)=>{
            this.eventBus.publish(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Events"].TOUCH_PINCH, e.scale);
        });
        // Two-finger Pan
        this.hammer.on('panmove', (e)=>{
            if (e.pointers.length === 2) {
                this.eventBus.publish(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Events"].TOUCH_PAN, {
                    x: e.deltaX,
                    y: e.deltaY
                });
            }
        ...
        this.hammer.on('press', (e)=>{
            this.eventBus.publish(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Events"].TOUCH_LONG_PRESS, {
                x: e.center.x,
                y: e.center.y
            });
        });
        ...
        this.hammer.on('doubletap', ()=>{
            this.eventBus.publish(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Events"].FOCUS_OBJECT);
        });
    }
    onKeyDown(event) {
        switch(event.key){
            case 'z':
                if (event.ctrlKey || event.metaKey) {
                    this.eventBus.publish(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Events"].UNDO);
                }
                break;
            case 'y':
                if (event.ctrlKey || event.metaKey) {
                    this.eventBus.publish(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Events"].REDO);
                }
                break;
            case 'Delete':
            case 'Backspace':
                this.eventBus.publish(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Events"].DELETE_OBJECT);
                break;
            case 'f':
            case 'F':
                this.eventBus.publish(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Events"].FOCUS_OBJECT);
...
"[project]/src/frontend/PhysicsManager.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class PhysicsManager {
    constructor(scene){
        this.world = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cannon$2d$es$2f$dist$2f$cannon$2d$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["World"]();
    ...
    addBody(mesh, mass = 1, shapeType = "box") {
        if (!mesh.geometry.parameters) {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$logger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].warn("Unsupported geometry for physics body. Geometry has no parameters.");
            return null;
        }
        let shape;
        switch(shapeType){
            case "box":
                {
                    const halfExtents = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cannon$2d$es$2f$dist$2f$cannon$2d$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vec3"](mesh.geometry.parameters.width / 2 * mesh.scale.x, mesh.geometry.parameters.height / 2 * mesh.scale.y, mesh.geometry.parameters.depth / 2 * mesh.scale.z);
                    shape = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cannon$2d$es$2f$dist$2f$cannon$2d$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Box"](halfExtents);
                    break;
                }
            case "sphere":
                {
                    shape = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cannon$2d$es$2f$dist$2f$cannon$2d$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Sphere"](mesh.geometry.parameters.radius * mesh.scale.x);
                    break;
                }
            case "cylinder":
                {
                    shape = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cannon$2d$es$2f$dist$2f$cannon$2d$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Cylinder"](mesh.geometry.parameters.radiusTop * mesh.scale.x, mesh.geometry.parameters.radiusBottom * mesh.scale.x, mesh.geometry.parameters.height * mesh.scale.y, mesh.geometry.parameters.radialSegments);
                    break;
                }
            default:
                {
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$logger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].warn("Unsupported shape type for physics body:", shapeType);
                    return null;
                }
        }
        const body = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cannon$2d$es$2f$dist$2f$cannon$2d$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Body"]({
            mass: mass,
            position: new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cannon$2d$es$2f$dist$2f$cannon$2d$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vec3"](mesh.position.x, mesh.position.y, mesh.position.z),
            quaternion: new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cannon$2d$es$2f$dist$2f$cannon$2d$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Quaternion"](mesh.quaternion.x, mesh.quaternion.y, mesh.quaternion.z, mesh.quaternion.w),
            shape: shape
        });
...
"[project]/src/frontend/PrimitiveFactory.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class PrimitiveFactory {
    constructor(){
        ...
        loader.load('./assets/fonts/helvetiker_regular.typeface.json', (font)=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$logger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].error('Error loading font:', err);
        });
    }
    _createMesh(geometry, color, side = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FrontSide"]) {
        const isTest = typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] !== 'undefined' && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.JEST_WORKER_ID;
        const cacheKey = `${color}_${side}`;
        if (!isTest && !this.materialCache[cacheKey]) {
            this.materialCache[cacheKey] = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MeshStandardMaterial"]({
                color,
                side,
                roughness: 0.5,
                metalness: 0.1
        ...
        const material = isTest ? new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MeshStandardMaterial"]({
            color,
            side,
            roughness: 0.5,
            metalness: 0.1
    ...
    _getCachedGeometry(type, options) {
        ...
        switch(type){
            case 'Box':
                geometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BoxGeometry"](params.width, params.height, params.depth, params.widthSegments, params.heightSegments, params.depthSegments);
                break;
            case 'Sphere':
                geometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SphereGeometry"](params.radius, params.widthSegments, params.heightSegments);
                break;
            case 'Cylinder':
                geometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CylinderGeometry"](params.radiusTop, params.radiusBottom, params.height, params.radialSegments);
                break;
            case 'Cone':
                geometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ConeGeometry"](params.radius, params.height, params.radialSegments);
                break;
            case 'Torus':
                geometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TorusGeometry"](params.radius, params.tube, params.radialSegments, params.tubularSegments);
                break;
            case 'TorusKnot':
                geometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TorusKnotGeometry"](params.radius, params.tube, params.tubularSegments, params.radialSegments);
                break;
            case 'Tetrahedron':
                geometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TetrahedronGeometry"](params.radius);
                break;
            case 'Icosahedron':
                geometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IcosahedronGeometry"](params.radius);
                break;
            case 'Dodecahedron':
                geometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DodecahedronGeometry"](params.radius);
                break;
            case 'Octahedron':
                geometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OctahedronGeometry"](params.radius);
                break;
            case 'Plane':
                geometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PlaneGeometry"](params.width, params.height, params.widthSegments, params.heightSegments);
                break;
            case 'Lathe':
                const pointsLathe = [];
                for(let i = 0; i < 10; i++){
                    pointsLathe.push(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector2"](Math.sin(i * 0.2) * 0.5 + 0.5, (i - 5) * 0.2));
                }
                geometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LatheGeometry"](pointsLathe, 12);
                break;
            case 'Tube':
                const tubePath = options.path || new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CatmullRomCurve3"]([
                    new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector3"](-0.5, 0, 0),
                    new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector3"](0, 0.5, 0),
                    new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector3"](0.5, 0, 0),
                    new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector3"](0, -0.5, 0)
                ]);
                geometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TubeGeometry"](tubePath, params.tubularSegments, params.radius, params.radialSegments, params.closed);
                break;
            case 'Extrude':
                ...
                geometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ExtrudeGeometry"](shape, {
                    steps: params.steps,
                    depth: params.depth,
    ...
    createPrimitive(type, options = {}) {
        if (type === 'Text') {
            return new Promise((resolve)=>{
                if (this.font) {
                    ...
                    const geometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$examples$2f$jsm$2f$geometries$2f$TextGeometry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextGeometry"](options.text || 'Polyhedra', {
                        font: this.font,
                        size: options.size || 0.5,
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$logger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].error('Font not loaded. Cannot create text.');
                    resolve(null);
                }
            });
        }
        if (type === 'Teapot') {
            const teapot = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Group"]();
            teapot.name = 'Teapot';
        ...
        let mesh;
        if (geometry) {
            mesh = this._createMesh(geometry, color, type === 'Plane' ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DoubleSide"] : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FrontSide"]);
        } else {
            // Handle specialized cases like LOD which might not be trivially cacheable
            switch(type){
                case 'LODCube':
                    const lod = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LOD"]();
                    const lodMaterial = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MeshStandardMaterial"]({
                        color: options.color || 0x00ff00,
                        roughness: 0.5,
                        metalness: 0.1
                    });
                    lod.addLevel(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Mesh"](this._getCachedGeometry('Box', {
                        width: 1,
                        height: 1,
                        depth: 1
                    }), lodMaterial), 0);
                    ...
                    break;
                default:
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$logger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].error(`Unknown primitive type: ${type}`);
                    return null;
            }
        }
        if (mesh) {
...
"[project]/src/frontend/ObjectFactory.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class ObjectFactory {
    ...
    async addPrimitive(type, options = {}) {
        ...
        if (mesh) {
            this.scene.add(mesh);
            this.eventBus.publish(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Events"].OBJECT_ADDED, mesh);
        }
        return mesh;
    }
    duplicateObject(object) {
...
"[project]/src/frontend/ObjectPropertyUpdater.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class ObjectPropertyUpdater {
   ...
   */ addTexture(object, file, type = 'map') {
        ...
        loader.load(url, (texture)=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$utils$2f$Logger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].warn('Error loading texture:', error);
            URL.revokeObjectURL(url);
        });
    }
    /**
...
"[project]/src/frontend/LightManager.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class LightManager {
    constructor(scene, eventBus){
        ...
        const ambientLight = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AmbientLight"](0x404040); // soft white light
        this.scene.add(ambientLight);
        this.lights.push(ambientLight);
        // Add a default directional light
        const directionalLight = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DirectionalLight"](0xffffff, 1);
    ...
    addLight(type, color, intensity, position, name) {
        ...
        switch(type){
            case 'PointLight':
                light = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PointLight"](color, intensity);
                break;
            case 'DirectionalLight':
                light = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DirectionalLight"](color, intensity);
                break;
            case 'AmbientLight':
                light = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AmbientLight"](color, intensity);
                break;
            default:
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$logger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].warn('Unknown light type:', type);
                return null;
        }
        ...
        this.eventBus.publish(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Events"].LIGHT_ADDED, light); // Emit event
        return light;
    }
    removeLight(light) {
        ...
        this.eventBus.publish(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Events"].LIGHT_REMOVED, light); // Emit event
    }
    updateLight(light, properties) {
        ...
        this.eventBus.publish(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Events"].LIGHT_UPDATED, light); // Emit event
    }
    changeLightType(oldLight, newType) {
        const oldPosition = oldLight.position ? oldLight.position.clone() : new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector3"]();
...
"[project]/src/frontend/ModelLoader.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class ModelLoader {
    constructor(scene, eventBus){
        this.scene = scene;
        this.eventBus = eventBus;
        this.objLoader = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$examples$2f$jsm$2f$loaders$2f$OBJLoader$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OBJLoader"]();
        this.gltfLoader = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$examples$2f$jsm$2f$loaders$2f$GLTFLoader$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GLTFLoader"]();
    }
    loadModel(file) {
        return new Promise((resolve, reject)=>{
            const url = URL.createObjectURL(file);
            ...
            const onLoad = (object)=>{
                // Normalize size
                const box = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Box3"]().setFromObject(object);
                const size = box.getSize(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector3"]());
                const maxDim = Math.max(size.x, size.y, size.z);
                ...
                object.traverse((child)=>{
                    if (child.isMesh) {
                        ...
                        if (!(child.material instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MeshStandardMaterial"]) && !(child.material instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MeshPhysicalMaterial"])) {
                            // Clone incompatible material props to Standard
                            const newMat = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MeshStandardMaterial"]({
            ...
            const onError = (e)=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$logger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].error("Error loading model:", e);
                URL.revokeObjectURL(url);
                reject(e);
            };
            if (ext === "obj") {
...
"[project]/src/frontend/AnimationManager.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/frontend/TimelineUI.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/frontend/ExportManager.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/frontend/ErrorHandler.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class ErrorHandler {
   ...
   */ static init(toastManager) {
        window.addEventListener('error', (event)=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$utils$2f$Logger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].error('Uncaught Exception', {
        ...
        window.addEventListener('unhandledrejection', (event)=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$utils$2f$Logger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].error('Unhandled Promise Rejection', {
                reason
            });
            if (toastManager) {
...
"[project]/src/frontend/ViewCube.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class ViewCube {
    constructor(mainCamera, orbitControls, containerObject){
        ...
        this.scene = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Scene"]();
        // Setup camera
        this.camera = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PerspectiveCamera"](50, 1, 0.1, 100);
        ...
        const geometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BoxGeometry"](1.5, 1.5, 1.5);
        ...
        const materials = faces.map((text)=>{
            ...
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MeshBasicMaterial"]({
                map: texture
            });
        });
        this.cube = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Mesh"](geometry, materials);
        this.scene.add(this.cube);
        // Edges
        const edges = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EdgesGeometry"](geometry);
        const line = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LineSegments"](edges, new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LineBasicMaterial"]({
            color: 0x000000,
            linewidth: 2
        }));
        this.cube.add(line);
        ...
        this.mouse = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector2"]();
    ...
    tweenToFace(faceIndex) {
        ...
        const targetPosition = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector3"]();
        ...
        new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tweenjs$2f$tween$2e$js$2f$dist$2f$tween$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Tween"](this.mainCamera.position).to({
            x: targetPosition.x,
            y: targetPosition.y,
            z: targetPosition.z
        }, 500).easing(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tweenjs$2f$tween$2e$js$2f$dist$2f$tween$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Easing"].Cubic.Out).onUpdate(()=>this.controls.update()).start();
...
"[project]/src/frontend/ShaderEditor.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class ShaderEditor {
   ...
   */ constructor(gui, renderer, scene, camera, eventBus, toastManager){
    ...
    createShader() {
        ...
        this.shaderMaterial = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ShaderMaterial"]({
            vertexShader: this.vertexShaderCode,
            fragmentShader: this.fragmentShaderCode,
            uniforms: this.uniforms
        });
        const mesh = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Mesh"](new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BoxGeometry"](1, 1, 1), this.shaderMaterial);
    ...
    openUI() {
        ...
        const switchTab = (type)=>{
            ...
            const newState = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EditorState"].create({
        ...
        this.editorView = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EditorView"]({
    ...
    compileShader() {
        ...
        try {
            ...
            // Build new material
            const newMaterial = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ShaderMaterial"]({
                vertexShader: this.vertexShaderCode,
                fragmentShader: this.fragmentShaderCode,
                uniforms: this.uniforms
            });
...
"[project]/src/frontend/UIManager.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/three/build/three.module.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$dat$2e$gui$2f$build$2f$dat$2e$gui$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/dat.gui/build/dat.gui.module.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$ShaderEditor$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/ShaderEditor.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$utils$2f$Logger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/utils/Logger.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/constants.js [app-client] (ecmascript)");
;
;
...
class UIManager {
   ...
   */ _ensureDependencies() {
    ...
    setupGUI() {
        ...
        this.gui = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$dat$2e$gui$2f$build$2f$dat$2e$gui$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GUI"]({
            autoPlace: false
        });
        ...
        new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$ShaderEditor$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ShaderEditor"](this.gui, this.renderer, this.scene, this.camera, this.eventBus, toastManager);
        ...
        const updateGrid = ()=>{
            if (this.eventBus) this.eventBus.publish(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Events"].UPDATE_GRID, viewParams);
        };
        ...
        viewFolder.add(viewParams, 'showAxes').name('Show Axes').onChange((val)=>{
            if (this.eventBus) this.eventBus.publish(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Events"].TOGGLE_AXES, val);
        });
    }
    setupMenu(callbacks) {
        const handlers = {
            ...
            loadInput.onchange = async (e)=>{
                ...
                if (file) {
                    try {
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$utils$2f$Logger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].error('Failed to load scene', err);
                    }
                }
                // @ts-ignore
                e.target.value = '';
    ...
    updatePropertiesPanel(object, callbacks) {
        ...
        // CSG Operations
        this.eventBus.publish(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Events"].UI_UPDATE_PROPERTIES, {
            object,
...
"[project]/src/frontend/HistoryManager.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class HistoryManager {
   ...
   */ constructor(container){
    ...
    saveState(objects, selectedObject, description = 'Action') {
        ...
        const stateObjects = objects.map((obj)=>{
            ...
            return {
                ...
                material: obj.material ? {
                    // @ts-ignore
                    color: obj.material.color ? obj.material.color.clone() : new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Color"](0xffffff),
                    // @ts-ignore
                    emissive: obj.material.emissive ? obj.material.emissive.clone() : new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Color"](0x000000)
                } : null,
        ...
        if (this.eventBus) {
            this.eventBus.publish(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Events"].HISTORY_CHANGED, {
...
"[project]/src/frontend/main.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tweenjs$2f$tween$2e$js$2f$dist$2f$tween$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tweenjs/tween.js/dist/tween.esm.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$examples$2f$jsm$2f$controls$2f$OrbitControls$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/three/examples/jsm/controls/OrbitControls.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$examples$2f$jsm$2f$controls$2f$TransformControls$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/three/examples/jsm/controls/TransformControls.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$SceneStorage$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/SceneStorage.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$utils$2f$ServiceContainer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/utils/ServiceContainer.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$StateManager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/StateManager.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$EventBus$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/EventBus.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$ObjectManager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/ObjectManager.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$SceneManager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/SceneManager.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$InputManager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/InputManager.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/constants.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$PhysicsManager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/PhysicsManager.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$PrimitiveFactory$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/PrimitiveFactory.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$ObjectFactory$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/ObjectFactory.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$ObjectPropertyUpdater$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/ObjectPropertyUpdater.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$ToastManager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/ToastManager.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$LightManager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/LightManager.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$utils$2f$Logger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/utils/Logger.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$ModelLoader$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/ModelLoader.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$AnimationManager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/AnimationManager.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$TimelineUI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/TimelineUI.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$ExportManager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/ExportManager.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$ErrorHandler$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/ErrorHandler.js [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$examples$2f$jsm$2f$postprocessing$2f$OutlinePass$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/three/examples/jsm/postprocessing/OutlinePass.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$ViewCube$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/ViewCube.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2d$csg$2d$ts$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/three-csg-ts/lib/esm/index.js [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2d$csg$2d$ts$2f$lib$2f$esm$2f$CSG$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/three-csg-ts/lib/esm/CSG.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$UIManager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/UIManager.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$HistoryManager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/frontend/HistoryManager.js [app-client] (ecmascript)");
;
;
;
;
...
class App {
    constructor(){
        ...
        this.toastManager = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$ToastManager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ToastManager"]();
        this.container = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$utils$2f$ServiceContainer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ServiceContainer"]();
        this.container.register('ToastManager', this.toastManager);
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$ErrorHandler$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ErrorHandler"].init(this.toastManager);
        ...
        this.container.register('EventBus', __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$EventBus$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]);
        this.stateManager = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$StateManager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StateManager"]();
        this.container.register('StateManager', this.stateManager);
        // Initialize Three.js Core
        this.scene = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Scene"]();
        this.camera = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PerspectiveCamera"](75, window.innerWidth / window.innerHeight, 0.1, 1000);
        ...
        // Initialize Managers
        this.primitiveFactory = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$PrimitiveFactory$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PrimitiveFactory"]();
        this.container.register('PrimitiveFactory', this.primitiveFactory);
        this.objectFactory = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$ObjectFactory$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ObjectFactory"](this.scene, this.primitiveFactory, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$EventBus$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]);
        this.container.register('ObjectFactory', this.objectFactory);
        this.objectPropertyUpdater = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$ObjectPropertyUpdater$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ObjectPropertyUpdater"](this.primitiveFactory);
        this.container.register('ObjectPropertyUpdater', this.objectPropertyUpdater);
        this.initRenderer();
        this.initPostProcessing();
        this.inputManager = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$InputManager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InputManager"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$EventBus$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], this.renderer.domElement);
        this.container.register('InputManager', this.inputManager);
        this.physicsManager = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$PhysicsManager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PhysicsManager"](this.scene);
        this.container.register('PhysicsManager', this.physicsManager);
        this.animationManager = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$AnimationManager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AnimationManager"]();
        this.container.register('AnimationManager', this.animationManager);
        this.exportManager = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$ExportManager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ExportManager"](this.renderer, this.scene, this.camera);
        this.container.register('ExportManager', this.exportManager);
        this.timelineUI = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$TimelineUI$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TimelineUI"](document.body, this.animationManager, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$EventBus$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], this.exportManager);
        this.sceneManager = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$SceneManager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SceneManager"](this.renderer, this.camera, this.inputManager, this.scene);
        this.container.register('SceneManager', this.sceneManager);
        this.objectManager = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$ObjectManager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ObjectManager"](this.scene, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$EventBus$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], this.physicsManager, this.primitiveFactory, this.objectFactory, this.objectPropertyUpdater, this.stateManager);
        this.container.register('ObjectManager', this.objectManager);
        this.uiManager = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$UIManager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UIManager"](this.container);
        this.historyManager = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$HistoryManager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HistoryManager"](this.container);
        // App State
        this.selectedObject = null;
        this.objects = [];
        ...
        this.sceneStorage = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$SceneStorage$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SceneStorage"](this.scene, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$EventBus$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]);
        // Initialize Model Loader
        this.modelLoader = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$ModelLoader$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ModelLoader"](this.scene, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$EventBus$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]);
        this.container.register('ModelLoader', this.modelLoader);
        // Bind animation loop
        this.animate = this.animate.bind(this);
        this.animate();
        // Initialize ViewCube
        this.viewCube = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$ViewCube$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ViewCube"](this.camera, this.sceneManager.controls, document.body);
        ...
        if (this.stateManager) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$EventBus$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].subscribe(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Events"].FOCUS_OBJECT, ()=>{
                if (this.selectedObject) {
                    this.sceneManager.focusOnObject(this.selectedObject);
                }
            });
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$EventBus$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].subscribe(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Events"].UPDATE_GRID, (params)=>{
                if (this.gridHelper) this.scene.remove(this.gridHelper);
                if (params.showGrid) {
                    this.gridHelper = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GridHelper"](params.gridSize, params.gridDivisions);
                    this.scene.add(this.gridHelper);
                }
                this.saveState('Update Grid Settings');
            });
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$EventBus$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].subscribe(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Events"].TOGGLE_AXES, (val)=>{
    ...
    initRenderer() {
        ...
        this.renderer.shadowMap.type = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PCFSoftShadowMap"];
    ...
    initPostProcessing() {
        this.composer = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$examples$2f$jsm$2f$postprocessing$2f$EffectComposer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EffectComposer"](this.renderer);
        const renderPass = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$examples$2f$jsm$2f$postprocessing$2f$RenderPass$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RenderPass"](this.scene, this.camera);
        this.composer.addPass(renderPass);
        const container = this.renderer.domElement.parentElement || document.body;
        const width = container.clientWidth || window.innerWidth;
        const height = container.clientHeight || window.innerHeight;
        this.outlinePass = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$examples$2f$jsm$2f$postprocessing$2f$OutlinePass$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OutlinePass"](new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector2"](width, height), this.scene, this.camera);
    ...
    setupControls() {
        this.orbitControls = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$examples$2f$jsm$2f$controls$2f$OrbitControls$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OrbitControls"](this.camera, this.renderer.domElement);
        this.orbitControls.enableDamping = true;
        this.orbitControls.dampingFactor = 0.05;
        this.transformControls = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$examples$2f$jsm$2f$controls$2f$TransformControls$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TransformControls"](this.camera, this.renderer.domElement);
    ...
    setupLighting() {
        const ambientLight = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AmbientLight"](0xffffff, 0.5);
        this.scene.add(ambientLight);
        const directionalLight = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DirectionalLight"](0xffffff, 0.8);
        directionalLight.position.set(5, 10, 7.5);
        directionalLight.castShadow = true;
        this.scene.add(directionalLight);
    }
    setupHelpers() {
        this.gridHelper = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GridHelper"](10, 10);
        this.scene.add(this.gridHelper);
        this.axesHelper = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AxesHelper"](5);
    ...
    performCSG(baseObject, targetUuid, operation) {
        ...
        if (!targetObject) {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$utils$2f$Logger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].warn('CSG Target not found');
            return;
        }
        try {
            ...
            let resultMesh;
            if (operation === 'union') resultMesh = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2d$csg$2d$ts$2f$lib$2f$esm$2f$CSG$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CSG"].union(baseObject, targetObject);
            else if (operation === 'subtract') resultMesh = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2d$csg$2d$ts$2f$lib$2f$esm$2f$CSG$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CSG"].subtract(baseObject, targetObject);
            else if (operation === 'intersect') resultMesh = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2d$csg$2d$ts$2f$lib$2f$esm$2f$CSG$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CSG"].intersect(baseObject, targetObject);
            if (resultMesh) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$utils$2f$Logger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].error(`CSG ${operation} failed:`, err);
    ...
    async importModel(file) {
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$utils$2f$Logger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].error('Import failed:', error);
    ...
    async saveScene() {
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$utils$2f$Logger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].error('Save failed', e);
    ...
    async loadScene(file) {
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$utils$2f$Logger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].error('Load failed', e);
    ...
    toggleFullscreen() {
        if (!document.fullscreenElement) {
            document.documentElement.requestFullscreen().catch((err)=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$frontend$2f$utils$2f$Logger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].error(`Error attempting to enable full-screen mode: ${err.message}`);
            });
        } else {
    ...
    animate() {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tweenjs$2f$tween$2e$js$2f$dist$2f$tween$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["update"]();
...
//# sourceMappingURL=src_frontend_6589eec1._.js.map