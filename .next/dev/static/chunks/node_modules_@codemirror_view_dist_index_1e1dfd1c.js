...
class InlineCoordsScan {
    ...
    scanText(tile, offset) {
        let positions = [];
        for(let i = 0; i < tile.length; i = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["findClusterBreak"])(tile.text, i))positions.push(offset + i);
    ...
    if (domChange.bounds) {
        ...
        if (!sel.empty && sel.from >= from && sel.to <= to && (domChange.typeOver || cmp != domChange.text) && cmp.slice(0, sel.from - from) == domChange.text.slice(0, sel.from - from) && cmp.slice(sel.to - from) == domChange.text.slice(selEnd = domChange.text.length - (cmp.length - (sel.to - from)))) {
            ...
            change = {
                from: sel.from,
                to: sel.to,
                insert: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Text"].of(domChange.text.slice(sel.from - from, selEnd).split(LineBreakPlaceholder))
            };
...
*/ class EditorView {
    ...
    */ constructor(config = {}){
        ...
        */ this.measureRequests = [];
        ...
        this.viewState = new ViewState(this, config.state || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EditorState"].create(config));
