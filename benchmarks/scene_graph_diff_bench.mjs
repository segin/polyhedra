...
runBenchmark("Baseline: Initial Render", () =>
  appMock.updateSceneGraph_Baseline(),
);

appMock.objectsList.innerHTML = "";
appMock.sceneGraphItemMap.clear();
runBenchmark("Optimized: Initial Render", () =>
...
runBenchmark("Baseline: Update Selection", () =>
  appMock.updateSceneGraph_Baseline(),
);
...
runBenchmark("Optimized: Update Selection", () =>
  appMock.updateSceneGraph_Optimized(),
);
