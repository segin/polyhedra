...
global.THREE = {
    ...
    TorusKnotGeometry: class { constructor() {} },
    IcosahedronGeometry: class { constructor() {} },
    DodecahedronGeometry: class { constructor() {} },
    OctahedronGeometry: class { constructor() {} },
    PlaneGeometry: class { constructor() {} },
    TubeGeometry: class { constructor() {} },
    LatheGeometry: class { constructor() {} },
...
global.TeapotGeometry = class { constructor() {} };
...
primitiveManagerCode = primitiveManagerCode.replace(/export class PrimitiveManager/, 'class PrimitiveManager');
